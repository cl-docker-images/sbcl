...
* Supported Tags
  ...
  + =2.0.4-ubuntu-eoan=, =2.0.4-ubuntu=, =ubuntu-eoan=, =ubuntu=
  + =2.0.4-ubuntu-eoan-fancy=, =2.0.4-ubuntu-fancy=, =ubuntu-eoan-fancy=, =ubuntu-fancy=
  + =2.0.4-ubuntu-eoan-build=, =2.0.4-ubuntu-build=, =ubuntu-eoan-build=, =ubuntu-build=
