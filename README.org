...
** Simple Tags
   ...
   + =2.0.7-ubuntu-focal=, =2.0.7-ubuntu=, =ubuntu-focal=, =ubuntu=
   + =2.0.7-ubuntu-focal-fancy=, =2.0.7-ubuntu-fancy=, =ubuntu-focal-fancy=, =ubuntu-fancy=
   + =2.0.7-ubuntu-focal-build=, =2.0.7-ubuntu-build=, =ubuntu-focal-build=, =ubuntu-build=
